...
def cpu_move(board, player_num):
    ...
    pri2=[(1,3),(1,6),(3,1),(3,3),(3,6),(3,8),(6,1),(6,3),(6,6),(6,8),(8,3),(8,6)]
    random.shuffle(pri2)
    ...
    pri5=[(2,4),(2,5),(3,4),(3,5),(4,2),(4,3),(4,6),(4,7),(5,2),(5,3),(5,6),(5,7),(6,4),(6,5),(7,4),(7,5)]
    random.shuffle(pri5)

    dame=[(1,2),(1,7),(2,1),(2,2),(2,7),(2,8),(7,1),(7,2),(7,7),(7,8),(8,2),(8,7)]
    random.shuffle(dame)
